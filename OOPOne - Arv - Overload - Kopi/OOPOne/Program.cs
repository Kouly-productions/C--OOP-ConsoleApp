        ...
        static void Main(string[] args)
        {
            ...
            */
            while (true)
            {
                ...
                Console.WriteLine("Write Student FirstName");
                var firstName = Console.ReadLine();
                Console.WriteLine("Write Student LastName");
                var lastName = Console.ReadLine();
                Console.WriteLine("Write Student Birth");
                var birthDate = Console.ReadLine();
                var student = new Enrollment(studentid, firstName, lastName, birthDate);
